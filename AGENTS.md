...
- `index.html` references `static/styles.css?v=6` and `static/app.js?v=6`. Bump the `v=` query param when deploying static asset changes to avoid stale browser caches.
