...
- `index.html` references `static/styles.css?v=7` and `static/app.js?v=8`. Bump the `v=` query param when deploying static asset changes to avoid stale browser caches.
